...
const links = {
  Serviços: [
    ...
    { label: "Loja Shopify", href: "#servicos" },
    { label: "Loja Next.js", href: "#servicos" },
    { label: "Consultoria Estratégica", href: "#servicos" },
  ],
  Empresa: [
    { label: "Cases", href: "#portfolio" },
    { label: "Sobre Eduardo", href: "#sobre" },
  ...
  Contato: [
    ...
    { label: "E-mail", href: "mailto:contato@impulsodigital.com.br" },
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 gap-6 sm:gap-8 md:gap-12">
          ...
          <div className="sf col-span-2 md:col-span-1">
            ...
            <p className="text-gray-500 text-sm leading-relaxed mb-1">
              Ajudamos empreendedores a existirem online — com estrutura real, entrega rápida e resultado de verdade.
            </p>
            <p className="text-primary text-xs font-semibold italic mb-6">
            ...
            <div className="flex gap-3">
              {socialLinks.map((s) => (
                <a
                  ...
                  aria-label={s.label}
                  className="w-9 h-9 bg-dark border border-dark-border rounded-lg flex items-center justify-center text-gray-500 hover:text-white hover:border-primary/50 hover:bg-primary/10 transition-all duration-200"
                >
                  {s.icon}
                </a>
              ))}
                ...
                {items.map((item) => (
                  <li key={item.label}>
                    <a
                      ...
                      className="text-gray-500 text-sm hover:text-primary-light transition-colors duration-200"
                    >
                      {item.label}
                    </a>
                  </li>
        ...
        <div className="container mx-auto px-5 md:px-6 py-5 md:py-6 flex flex-col md:flex-row items-center justify-between gap-3 md:gap-4">
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-green-500 text-xs hover:text-green-400 transition-colors font-medium"
            >
              WhatsApp
            </a>
          </div>
...
const socialLinks = [
  {
    label: "Instagram",
    href: "https://instagram.com/edubarrosch",
    icon: (
